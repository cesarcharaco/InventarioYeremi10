...
<main class="app-content">
  {{-- 1. VERIFICACIÓN DE PERMISO ESTRICTO (ESTILO CATEGORÍAS) --}}
  @cannot('crear-configuracion')
    <div class="tile text-center">
        <h1 class="text-danger"><i class="fa fa-lock"></i> Acceso Restringido</h1>
        <p>Solo el Administrador del Sistema puede configurar tasas y modelos de cálculo.</p>
...
{{-- Modal de Eliminación (Solo accesible si pasa el @cannot) --}}
